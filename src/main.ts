...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const playerIcon = L.icon({
        iconUrl: 'https://github.com/phoebila/cmpm-121-demo-3/blob/main/src/assets/pin.png',
        iconSize: [32, 32],
        iconAnchor: [16, 32],
        tooltipAnchor: [0, -30]
    });
        ...
        const updatePopup = () => {
            ...
            if (gridCell) {
                ...
                const coinDescriptions = cache.coins.map(coin => {
                    ...
                    const coinImageSrc = `https://github.com/phoebila/cmpm-121-demo-3/tree/main/src/assets/${coin.type.toLowerCase()}.png`; // coin types are 'Copper', 'Silver', 'Gold', etc.
